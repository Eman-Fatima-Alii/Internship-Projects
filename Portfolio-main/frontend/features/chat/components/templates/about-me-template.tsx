...
const SECTIONS = [
    {
        html: `Hi there! 👋 I'm **Eman Fatima**, a Full Stack AI Engineer and LLM Architect. I'm passionate about building intelligent software systems that merge artificial intelligence with modern web experiences.`
    },
    {
        html: `My work focuses heavily on **Artificial Intelligence & LLMs** — designing custom conversational agents, integrating OpenAI GPT models, prompt engineering, and building agentic workflows that solve complex problems.`
    },
    {
        html: `On the full-stack side, I build responsive, accessible web interfaces using **React.js**, **Next.js**, **Tailwind CSS**, and modern glassmorphism styling, backed by scalable **Python** and **Node.js** API microservices.`
    },
    {
        html: `I also specialize in **Workflow Automation** ⚡ — creating Python automation scripts, web scrapers, and data pipelines that streamline repetitive tasks and save valuable time.`
    },
    {
        html: `With over **20+ completed projects** and **10+ core technologies mastered**, I'm always eager to collaborate on forward-thinking AI products!`,
        isItalic: true
    }
]
                ...
                >
                    <div className="rounded-xl overflow-hidden border border-white/10 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 p-2 md:p-3 shadow-xl">
                        <div className="aspect-[4/3] md:aspect-[4/5] bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-lg overflow-hidden relative">
                            <Image
                                src="/eman.png"
                                alt="Eman Fatima - Full Stack AI Engineer"
                                fill
