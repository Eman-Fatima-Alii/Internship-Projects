...
class Settings(BaseSettings):
    ...
    PORTFOLIO_OWNER: str = "Eman Fatima"
    RESUME_LINK: str = "/resume.pdf"
    ...
    VECTOR_DB_COLLECTION: str = "eman_fatima_portfolio_v1"
    ...
    OWNER_EMAIL: EmailStr = "emaanfatimaa2121@gmail.com"

    # --- Social Platforms ---
    GITHUB_USERNAME: Optional[str] = "Eman-Fatima-Alii"
    GITHUB_TOKEN: Optional[SecretStr] = None
    LINKEDIN_USERNAME: Optional[str] = "eman-fatima-34468a356"
