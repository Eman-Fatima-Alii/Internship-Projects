...
export default function HomePage() {
  ...
  const title = useMemo(() => {
    if (activeQuery) return `Stories for "${activeQuery}"`;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8fafc] dark:bg-[#070a0f] text-slate-900 dark:text-slate-100 transition-colors duration-300">
      <Ticker articles={articles} onOpenArticle={setOpenArticle} />
